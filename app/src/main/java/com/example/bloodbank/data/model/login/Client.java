...
public class Client {
    ...
    @SerializedName("city")
    @Expose
    private GeneralModelData city;
    @SerializedName("blood_type")
    @Expose
    private GeneralModelData bloodType;
    ...
    public GeneralModelData getCity() {
        return city;
    }

    public void setCity(GeneralModelData city) {
        this.city = city;
    }

    public GeneralModelData getBloodType() {
        return bloodType;
    }

    public void setBloodType(GeneralModelData bloodType) {
